...
const data = {
  menus: [
    ...
    { text: 'Cliente', icon: <ContactIcon/>, link: '/client/register', 
      subMenu: [
        { text: 'Cadastrados', icon: <GridOn/>, link: '/client/register' },
        { text: 'Cadastrar', icon: <PermIdentity/>, link: '/client/register' }
      ] 
    },
    { text: 'Table Page', icon: <GridOn/>, link: '/table' },
    { text: 'Login Page', icon: <Web/>, link: '/login' }
  ],
  tablePage: {
    items: [
